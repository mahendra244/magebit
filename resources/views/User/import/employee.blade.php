...
<div class="row m-t-70 admin-home  p-l-r-0">
	<div class="col-md-12 col-sm-12 col-xs-12 p-l-r-0">
    	<div class="col-md-12 col-sm-12 col-xs-12 card-block">
            ...
            <form action="{{ url('user/post-employee-data') }}" method="POST" id="importform" name="importform" enctype="multipart/form-data">
            {!!csrf_field()!!}
                <div class="row ">
                    ...
                    <div class="col-sm-4 col-md-4 col-xs-12">
                        <div class="box">
                            <div class="download-text">
                                <p class="select-file">Import employee data</p>
                                ...
                                <div class="upload-btn-wrapper">
                                    ...
                                    @endif
                                    <input type="file" name="excel_input" data-url="{{ url('user/post-import-employee-data') }}" id="excel_input" />
                                    {!!csrf_field()!!}
                                </div>
                ...
                <div class="row" style="margin-top: 20px;">
                    ...
                    <div class="col-sm-4 col-md-4 col-xs-12 text-center">
                        <button class="btn btn-primary sub-btn btn-import" id="btn-import">Submit</button>
                    ...
                    <a class="card-content" href="#">
                        <div class="">
                            ...
                            <p class="card-details">
                                <a download href="{{asset('reports/'.$value->file_name)}}">Imported excel Download</a>  |
                                <a  href="{{url('user/employee-data/'.$value->unique_code)}}">View</a> |
						        <a  href="{{url('user/all-employee-updated-report/'.$value->unique_code)}}">Updated report download</a> |
                                <a  href="{{url('user/emp_match_preview/'.$value->unique_code)}}">Preview </a>
