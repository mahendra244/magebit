            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 p-l-r-0">
                        <form class="form-login" method="post" action=" {{ url('user-store') }} ">
                           @csrf
                            <h2 class="form-login-heading" style="text-transform:none !important"> Registration</h2>
                            ...
                            @endif
                                ...
                                <div class="login-wrap">
                                    ...
                                    <div class="form-group has-feedback ">
                                        <input type="password" class="form-control" placeholder="Phone *" name="phone" value="{{ old('phone') }}">
                                        {!! $errors->first('phone', '<small class="text-danger">:message</small>') !!}

                                    </div>
                                    
                                    <button  class="btn btn-primary btn-theme btn-block" type="submit" >Register</button>
                                    <hr>
